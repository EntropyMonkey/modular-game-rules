...
public class MessageBox : Dialog
{
    ...
    private MessageBox(string title, string message)
    {
        ...
        TitleLabel.MouseDown += delegate(Control sender, MouseEventArgs e) { if(e.Button == 0) StartDrag(); };
        TitleLabel.MouseUp += delegate(Control sender, MouseEventArgs e) { if (e.Button == 0) StopDrag(); };
