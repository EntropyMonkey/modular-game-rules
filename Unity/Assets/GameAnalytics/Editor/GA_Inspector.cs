...
public class GA_Inspector : Editor
{
	...
	private static void GetGameInfo (GA_Settings ga)
	{
		...
		WWW www = new WWW("https://go.gameanalytics.com/v1/games/" + ga.Studios[ga.SelectedStudio-1].GameIDs[ga.SelectedGame-1], null, new Hashtable(headers));
	...
	private static void GetUserData (GA_Settings ga)
	{
		...
		WWW www = new WWW("https://go.gameanalytics.com/v1/user/data", null, new Hashtable(headers));
